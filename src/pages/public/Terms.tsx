    ...
    <div className="py-16 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-sm text-slate-600 leading-relaxed">
          {[
            { title: "1. Acceptance of Terms", body: 'By accessing or using Salez.online ("Service"), you agree to be bound by these Terms and Conditions. If you do not agree to these terms, please do not use our service.' },
            { title: "2. Use of Service", body: "You may use Salez.online only for lawful purposes and in accordance with these Terms. You agree not to use the Service to send spam, unsolicited messages, or any content that violates WhatsApp's terms of service or applicable laws." },
            { title: "3. WhatsApp Compliance", body: "All messages sent through Salez.online must comply with Meta's WhatsApp Business Policy. You are solely responsible for obtaining proper opt-in consent from your contacts before sending messages." },
            ...
            { title: "7. Limitation of Liability", body: "Salez.online shall not be liable for any indirect, incidental, or consequential damages arising from your use of the service, including message delivery failures or WhatsApp account restrictions." },
